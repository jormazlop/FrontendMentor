...
@Component({
  selector: 'app-create-your-plan-how-it-works',
  standalone: true,
  imports: [],
  templateUrl: './create-your-plan-how-it-works.component.html',
  styleUrl: './create-your-plan-how-it-works.component.scss'
})
export class CreateYourPlanHowItWorksComponent {
